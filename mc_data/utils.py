...
def deal_judge(pred):
    if pred is None:
        return True
    if has_answer(["sorry", "apologize", "apologies", "unknown", "no specific answer", "not provide", "cannot answer", "no information provided", "no answer", "not contain", "no definitive answer"], pred):
        return True
    return False
