...
class GenerationMixin:
    ...
    def generate(
        ...
        **kwargs,
        ...
        if not self.config.is_encoder_decoder and model_input_name == "inputs_embeds": # model_input_name = input_ids
            model_kwargs["use_cache"] = True
        else: # 走的这个
            model_kwargs["use_cache"] = generation_config.use_cache # default=true

        accepts_attention_mask = "attention_mask" in set(inspect.signature(self.forward).parameters.keys())
        requires_attention_mask = "encoder_outputs" not in model_kwargs

        if model_kwargs.get("attention_mask", None) is None and requires_attention_mask and accepts_attention_mask:
            print('use _prepare_attention_mask_for_generation')
        ...
        has_default_max_length = kwargs.get("max_length") is None and generation_config.max_length is not None # default: max_length=20
        has_default_min_length = kwargs.get("min_length") is None and generation_config.min_length is not None # default: min_length=0
        ...
        print(f'generation_config after prepare: {generation_config}')
        ...
        if self.device.type != input_ids.device.type: # load data to the device when passing
            warnings.warn(
